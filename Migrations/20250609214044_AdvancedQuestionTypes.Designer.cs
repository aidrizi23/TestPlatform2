...
namespace TestPlatform2.Migrations
{
    ...
    [Migration("20250609214044_AdvancedQuestionTypes")]
    partial class AdvancedQuestionTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestPlatform2.Data.TestShare", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TestPlatform2.Data.TestShare", b =>
                {
                    b.HasOne("TestPlatform2.Data.User", "OwnerUser")
                        .WithMany("OwnedShares")
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TestPlatform2.Data.User", "SharedWithUser")
